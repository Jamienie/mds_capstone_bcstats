...
knitr::opts_chunk$set(warning = FALSE, message = FALSE, root.dir = normalizePath(".."))
...
# may be able to do some form of ungroup to deal with the aggregation issue
...
- flexible work environment & job_suitability don't really match -- not sure what to do about this *** DO NOT start writing about results until this corrected
 - not sure how much I need to figure this out because this isn't really the deliverable for the client
...
rmarkdown::render(input = "notebooks/ap_qual_to_quant_base_model.Rmd", 
                   knit_root_dir = "..",
