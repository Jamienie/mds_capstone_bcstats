...
<br>  
  ...
  <img src="./imgs/WES_report.png" alt="drawing" width="300"/>
</div>
...
- questions relate to <span style="color:Darkblue">**day-to-day work, management, performance, pay & benefits, ect.**</span>    

Qualitative data (comments/open ended responses)  
...
<div class="columns-2">
  <img src="./imgs/engagement_model.png" alt="drawing" width="350"/>
...
## Introduction | Qualitative Data 
<div class="centered">
  <img src="./imgs/comment_plot.png" alt="drawing" width="600"/>
</div>
...
<span style="color:Darkblue">**3. Trends** - What trends exist over time and across departments from the 2008 to 2018 quantitative survey data?</span> 
...
- Complex Model: Utilize Word Embeddings and apply neural nets  
...
- Python script with trained Model for future labelling
...
- Base Model: percent agreement calculation  
- Complex Model: Cohen's kappa or Krippendorff's alpha  
...
<img src="./imgs/timeline.png" alt="drawing" width="800"/>
