...
# June 2019
#
# Purpose: Tidy's the raw quanititative data into two csv files, one with the scores
...
#
# General example:
# Rscript src/data/tidy_quantitative_data.R  input_quant input_legend output_questions
# 
# Real example:
# Rscript src/data/tidy_quantitative_data.R  "./data/raw/WES 2007-2018 LONGITUDINAL DATA_short.sav" "./references/data-dictionaries/survey_mc_legend.csv" "./data/interim/tidy_quant_questions.csv"
