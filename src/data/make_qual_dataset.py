...
# Usage with 2015 and 2018 train datasets: python make_qual_dataset.py "../../data/interim/train_2015-qualitative-data.csv" "../../data/interim/train_2018-qualitative-data.csv" "../../data/interim/qual_combined_train.csv"
