...
#
# General example:
# Rscript src/visualization/linking_agreement_figure_subtheme.R input_file output_file
#
# Real example:
...
main <- function(){
  ...
  test_that("Check loss function is taking minimum for each subtheme per person", {
